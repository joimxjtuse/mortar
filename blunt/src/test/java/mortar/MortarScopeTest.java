...
public class MortarScopeTest {
  ...
  class AbleBlueprint extends BluntBlueprint {
  ...
  class BakerBlueprint extends BluntBlueprint {
    @Override public String getMortarScopeName() {
      return Bagel.class.getName();
    }
  ...
  class CharlieBlueprint extends BluntBlueprint {
    @Override public String getMortarScopeName() {
      return Carrot.class.getName();
    }
  ...
  class DeltaBlueprint extends BluntBlueprint {
    @Override public String getMortarScopeName() {
      return Dogfood.class.getName();
    }
  ...
  class MoreModules extends BluntBlueprint {
  ...
  class NoModules extends BluntBlueprint {
